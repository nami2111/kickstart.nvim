...
```sh
git clone git@github.com:nami2111/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone git@github.com:nami2111/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone git@github.com:nami2111/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
